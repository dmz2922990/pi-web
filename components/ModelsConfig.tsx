...
export function ModelsConfig({ onClose, embedded, onModelsSaved }: { onClose: () => void; embedded?: boolean; onModelsSaved?: () => void }) {
  ...
  const handleSave = useCallback(async () => {
    ...
    try {
      ...
      else { setSavedOk(true); onModelsSaved?.(); setTimeout(() => setSavedOk(false), 2000); }
    } catch (e) {
